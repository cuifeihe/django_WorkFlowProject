"""
Django settings for WorkflowProject project.
...
SECRET_KEY = 'django-insecure-369@f01)rc7n_k0$k16hvy38%x$x4&oe!-o)xe_d!63@vo%xz_'
...
MIDDLEWARE = [
    ...
    'common.middleware.JsonDataMiddleware',
